...
c---------------------------------
      parameter (cr6=5.5D+14/0.4D0)       !Roi  
      parameter (cr7=4.0D+14/0.4D0)       !Rio
      parameter (cr8=4.0D+14/0.4D0)       !Ree
      parameter (cr5=cr6+cr7-cr8)          !Roo
      parameter (k2=8.0D0)                 !Ka
c---------------------------------
c     Astrocyte interstitium GLC transp
c---------------------------------
      parameter (cr10=4.4D+13/0.4D0)       !Roi
      parameter (cr11=3.2D+13/0.4D0)       !Rio
      parameter (cr12=3.2D+13/0.4D0)       !Ree
...
c---------------------------------
      ...
      parameter (Va=GCF/(cr10*3.08d0))                 !astrocyte Vmax hexokinase       !Yes
      parameter (Vn=GRB*0.9d0/(3.03d0*2.95D0*cr14))    !neuron Vmax hexokinase          !No change during simulation
      parameter (ORB=0.184D0)                          !scaling factor
      parameter (OCF=ORB+0.0d0)
      parameter (Val=OCF*0.24D0/(0.93d0*cr26))         !astrocyte Vmax lactate          !Yes
      parameter (Vnl=1.22D0*OCF/(0.918d0*cr30))        !neuron Vmax lactate             !Yes
